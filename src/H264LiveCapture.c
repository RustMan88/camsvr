...
static char s_filterDesc[] 
    = "drawtext=fontfile=/usr/share/fonts/default/Type1/n019003l.pfb:x=5:y=5:fontcolor=white:fontsize=30:shadowcolor=black:shadowx=2:shadowy=2:text=\\'%{localtime\\:%Y/%m/%d %H\\\\\\:%M\\\\\\:%S}\\'";
